...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"ÇëÊäÈëÃÜÂë£º";
			// 
			// label2
			// 
			this->label2->AutoSize = true;
			this->label2->Location = System::Drawing::Point(22, 124);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(127, 15);
			this->label2->TabIndex = 1;
			this->label2->Text = L"ÇëÖØÐÂÊäÈëÃÜÂë£º";
			// 
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(82, 81);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(99, 206);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(75, 23);
			this->button1->TabIndex = 4;
			this->button1->Text = L"È·ÈÏ";
...
#pragma endregion
	private: 
		...
		System::Void SetPassword(String^ input);
};
}
